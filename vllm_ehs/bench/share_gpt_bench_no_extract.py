...
def main() -> None:
    ...
    p.add_argument("--write-to-disk", type=bool, default=True,
                   help="If True, writes extracted tensors to a temporary file on disk, " \
                   "using ExampleHiddenStatesConnector. If false, does not write using NoWritesConnector.")
    args = p.parse_args()
