...
DRIVER="share_gpt_bench_no_extract.py"
RESULTS="/shared/CMSC818Q_proj/results-share-no-extract-${SLURM_JOB_ID}.csv"
touch "${SHARED}"/CMSC818Q_proj/results-share-no-extract-"${SLURM_JOB_ID}".csv
