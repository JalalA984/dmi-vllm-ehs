# Modified from vllm commit 2268224 file vllm/vllm/distributed/kv_transfer/kv_connector/v1/example_hidden_states_connector.py
import os
...
@dataclass
class NoWritesConnectorMetadata(KVConnectorMetadata):
...
class NoWritesConnector(KVConnectorBase_V1):
    """
    ...
    def __init__(
        ...
        assert self._vllm_config.speculative_config is not None, (
            "NoWritesConnector only works when using "
    ...
    def save_kv_layer(
        ...
        **kwargs: Any,
        ...
        assert isinstance(attn_metadata, CacheOnlyAttentionMetadata), (
            "NoWritesConnector only supports CacheOnlyAttentionBackend"
        )

        connector_metadata = self._get_connector_metadata()
        assert isinstance(connector_metadata, NoWritesConnectorMetadata)
    ...
    def build_connector_meta(
        ...
        """
        meta = NoWritesConnectorMetadata()
